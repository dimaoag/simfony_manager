...
build-production:
	...
	docker build --pull --file=manager/docker/production/mysql.docker --tag ${REGISTRY_ADDRESS}/manager-postgres:${IMAGE_TAG} manager
...
push-production:
	...
	docker push ${REGISTRY_ADDRESS}/manager-mysql:${IMAGE_TAG}
